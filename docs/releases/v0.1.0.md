...
> Status: Prepared for the `v0.1.0` release publication  
> Compare basis: Full shipped history from the root commit for the initial release  
> Scope: This note pairs with the `v0.1.0` tag and the companion launch guide.

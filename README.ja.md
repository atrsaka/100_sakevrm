...
- [ポッドキャストベンチマーク レポート](./docs/ja/podcast-benchmark.md)
- [YouTube Relay Guide](./docs/ja/youtube-relay.md)
- [Release Notes](./docs/ja/releases.md)
- [Release Articles](./docs/ja/articles.md)
- [最新の v0.3.0 リリースノート](./docs/ja/releases/v0.3.0.md)
- [最新の v0.3.0 Runtime と Benchmark ガイド](./docs/ja/articles/v0.3.0-runtime-and-benchmark-guide.md)
...
自然な日本語トピックの bilingual ベンチマーク画像とレイアウト検知については、[ポッドキャストベンチマーク レポート](./docs/ja/podcast-benchmark.md) を参照してください。

- `npm run report:podcast-benchmark`
  - 英語版 / 日本語版の SVG・PNG と共有 JSON を再生成します
  - あわせて `docs/public/benchmarks/podcast-benchmark-history.json` と `.csv` も更新します
  - 追跡項目は `generatedAt`, `benchmarkKey`, `gitSha`, `sourceKind`, `topics`, `firstAudio*`, `handoff*` です
- `npm run verify:podcast-benchmark-layout`
  - `data-fit-boundary` の欠落、文字の枠外はみ出し、文字同士の重なりを検知します
